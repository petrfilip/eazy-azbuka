import 'package:eazy_azbuka/Azbuka.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: QuizPage(title: 'Eazy Azbuka'),
    );
  }
}
              ...
              children: <Widget>[
                ...
                Expanded(
                  child: RaisedButton(
                    ...
                    onPressed: () => _checkAnswerAndLoadNewQuestions(answers[0]),
                    child: new Text(
                      answers[0],
                      style: new TextStyle(
                        fontWeight: FontWeight.bold,
                ...
                Expanded(
                  child: new RaisedButton(
                    ...
                    onPressed: () => _checkAnswerAndLoadNewQuestions(answers[1]),
                    child: new Text(
                      answers[1],
                      style: new TextStyle(
                        fontWeight: FontWeight.bold,
                ...
                Expanded(
                  child: new RaisedButton(
                    ...
                    onPressed: () => _checkAnswerAndLoadNewQuestions(answers[2]),
                    child: new Text(
                      answers[2],
                      style: new TextStyle(
                        fontWeight: FontWeight.bold,
